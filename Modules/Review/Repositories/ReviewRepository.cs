...
{
    public class ReviewRepository(IMovieService movieService, MovieDbContext context) : IReviewRepository
    {
        ...
        public async Task<Review?> PostMovieReviewAsync(Guid movieId, ReviewRequest reviewRequest)
        {
            await _movieService.CheckifMovieExists(movieId);
        ...
        public async Task<Review?> UpdateAsync(Guid id, ReviewRequest updateReview)
        {
